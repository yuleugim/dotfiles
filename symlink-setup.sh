...
FILES_TO_SYMLINK="$FILES_TO_SYMLINK .vim bin .oh-my-zsh" # add in vim and the binaries
...
main() {
    ...
    local sourceFile=""
    local targetFile=""
    local backupFolder="$(pwd)/._old_dotfiles/$(date +'%Y-%m-%d_%H-%M-%S')"
